...
import 'package:my_office/PR/invoice/model/invoice.dart';
import 'package:my_office/PR/invoice/model/supplier.dart';

class TaskData extends ChangeNotifier{
  final List<Customer> customerData = [
  // Customer(name: " ", street: " ", address: " ",phone: 0,gst: " ")
  ];
  ...
  void addTask(String name,String street,String address,int phone,String gst) {
    final task = Customer(name: name, street: street, address: address,phone:phone,gst:gst);
